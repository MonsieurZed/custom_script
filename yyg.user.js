...
ferveX(document).ready(function () {
  ...
  function setCookie(name, value, days) {
    ...
    document.cookie =
      name + "=" + (value || "") + expires + ";domain=.ygg.re;path=/";
  }
  ...
  ferveX(document).ready(function () {
    ...
    if (upUnite == "Po") {
      up = up.slice(0, -2) * 1125899906842624;
    } else if (upUnite == "To") {
    ...
    if (downUnite == "Po") {
      down = down.slice(0, -2) * 1125899906842624;
    } else if (downUnite == "To") {
  ...
  ferveX(document).on("click", ".config-notifs-on", function (e) {
    ...
    ferveX('#top_panel a[href="https://www.ygg.re/user/notifications"]')
      .parent()
      .show();
  ...
  ferveX(document).on("click", ".config-preview-off", function (e) {
    ...
    removePreview();
    ferveX(
      "a[id^='torrent_name'], a[href^='https://www.ygg.re/torrent/']"
  ...
  function addPreview() {
    ...
    ferveX("a[id^='torrent_name'], a[href^='https://www.ygg.re/torrent/']")
      .on("mouseenter", function (e) {
    ...
    ferveX("a[id^='torrent_name'], a[href^='https://www.ygg.re/torrent/']").on(
      "mousemove",
      function (e) {
        var mouseY = e.pageY - ferveX(window).scrollTop(); // Coordonnée Y du curseur par rapport à la fenêtre visible
  ...
  ferveX(document).bind("mouseup", function () {
    ...
    if (texteSelection != "" && fervexTemp != "1") {
      ...
      ferveX(".fervexTools a").attr(
        "href",
        "https://www.ygg.re/engine/search?name=" + texteSelection + "&do=search"
      );
  ...
  if (url.indexOf("/forum/") > -1) {
    ferveX(document).ready(function () {
      ...
      horloge("hqc", "America/Toronto");

      function horloge(el, timezone) {
        if (typeof el === "string") {
        ...
        function actualiser() {
          ...
          var str = date.toLocaleTimeString("fr-FR", options);
          el.innerHTML = str;
        }
      ...
      ferveX(".message-userDetails .message-name .username").each(function () {
        ...
        var userProfil,
          ...
          userDelta;
        var urlSearch =
          "https://www.ygg.re/engine/search_users?nickname=" +
    ...
    ferveX(document).ready(function () {
      ...
      if (url.indexOf("/user/my_torrents") > -1) {
        ...
        async function getTableData(pageNumber) {
          let url = `https://www.ygg.re/user/my_torrents?page=${
            pageNumber * 50
          }`;
